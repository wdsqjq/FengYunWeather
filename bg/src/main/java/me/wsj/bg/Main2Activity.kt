...
import me.wsj.bg.adapter.SwipeAdapter
import me.wsj.bg.bean.WeatherBean
import me.wsj.bg.databinding.ActivityMain2Binding
...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = SwipeAdapter(this, mData, { startActivity<ShowActivity>("code" to it.code) }) {
            mData.removeAt(it)
